...
const PALETTE_LIST = [
	...
	},
	{
		...
		type: "game",
		colorList: [
			{ hex: "#8fdbe9", type: "character", desc: "辻倉朱比華 「anemoi」キャラクターアイコン背景色" },
			{ hex: "#ffde59", type: "character", desc: "総羽愛乃 「anemoi」キャラクターアイコン背景色" },
			{ hex: "#fea8b1", type: "character", desc: "淡雪陽彩 「anemoi」キャラクターアイコン背景色" },
			{ hex: "#ffa95e", type: "character", desc: "白渡小詠 「anemoi」キャラクターアイコン背景色" },
			{ hex: "#c19bd6", type: "character", desc: "速川六花 「anemoi」キャラクターアイコン背景色" },
			{ hex: "#5cdcea", type: "character", desc: "辻倉朱比華 「anemoi」SDキャラクターアイコン背景色" },
			{ hex: "#ffdf4e", type: "character", desc: "総羽愛乃 「anemoi」SDキャラクターアイコン背景色" },
			{ hex: "#ffaab5", type: "character", desc: "淡雪陽彩 「anemoi」SDキャラクターアイコン背景色" },
			{ hex: "#ffab56", type: "character", desc: "白渡小詠 「anemoi」SDキャラクターアイコン背景色" },
			{ hex: "#cf9dd9", type: "character", desc: "速川六花 「anemoi」SDキャラクターアイコン背景色" },
			{ hex: "#8fdbe9", type: "character", desc: "辻倉朱比華 「anemoi」キャラクター情報の文字色" },
			{ hex: "#ffdc61", type: "character", desc: "総羽愛乃 「anemoi」キャラクター情報の文字色" },
			{ hex: "#ffaab7", type: "character", desc: "淡雪陽彩 「anemoi」キャラクター情報の文字色" },
			{ hex: "#ffa555", type: "character", desc: "白渡小詠 「anemoi」キャラクター情報の文字色" },
			{ hex: "#c498d7", type: "character", desc: "速川六花 「anemoi」キャラクター情報の文字色" },
			{ hex: "#303C42", type: "character", desc: "速川麦 「anemoi」キャラクター情報の文字色" },
			{ hex: "#E8EF89", type: "character", desc: "華押つづら 「anemoi」キャラクター情報の文字色" },
			{ hex: "#A4DEBF", type: "character", desc: "尾道文弥 「anemoi」キャラクター情報の文字色" },
			{ hex: "#927AC1", type: "character", desc: "敦澤塁 「anemoi」キャラクター情報の文字色" },
			{ hex: "#FFDEC0", type: "character", desc: "鉱玖琉未 「anemoi」キャラクター情報の文字色" },
			{ hex: "#43BA17", type: "character", desc: "河瀬千春 「anemoi」キャラクター情報の文字色" },
			{ hex: "#C42675", type: "character", desc: "小森健 「anemoi」キャラクター情報の文字色" },
			{ hex: "#EA8B8B", type: "character", desc: "花山広美 「anemoi」キャラクター情報の文字色" },
			{ hex: "#CE6042", type: "character", desc: "総羽湊 「anemoi」キャラクター情報の文字色" },
			{ hex: "#3BA3CC", type: "character", desc: "敦澤 誠 「anemoi」キャラクター情報の文字色" },
			{ hex: "#303C42", type: "character", desc: "ツミレ 「anemoi」キャラクター情報の文字色" },
	...
	},
	{
		...
		type: "game",
		colorList: [
			{ hex: "#f20000", type: "background", desc: "背景色1" },
			{ hex: "#0e0000", type: "background", desc: "背景色2" },
		],
	},
	{
		title: "ぬきたし2",
		type: "game",
		colorList: [
			{ hex: "#f20000", type: "background", desc: "SS BIG4" },
			{ hex: "#0082f2", type: "background", desc: "NLNS" },
		],
	},
	{
		title: "ヘンプリ",
		type: "game",
		colorList: [
			{ hex: "#ffff00", type: "background", desc: "背景色1" },
			{ hex: "#000000", type: "background", desc: "背景色2" },
		],
	},
	{
		title: "現代アート",
		type: "meme",
		colorList: [
			{ hex: "#a1726a", type: "background", desc: "背景色1" },
			{ hex: "#c8beb5", type: "background", desc: "背景色2" },
			{ hex: "#3e343f", type: "background", desc: "背景色3" },
			{ hex: "#969f9a", type: "background", desc: "背景色4" },
		],
	},
];
